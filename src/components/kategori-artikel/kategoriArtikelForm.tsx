...
import { KategoriArtikel } from "@/services/kategoriArtikel";
import useGoBack from "@/hooks/useGoBack";

interface Props {
  initialData?: KategoriArtikel;
  onSubmit: (data: Omit<KategoriArtikel, "id">) => Promise<void>;
}
...
export default function KategoriArtikelForm({ initialData, onSubmit }: Props) {
